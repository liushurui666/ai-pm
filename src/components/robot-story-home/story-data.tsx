...
export const robotStoryChapters: RobotStoryChapter[] = [
  ...
  },
  {
    ...
    accent: "#9b8cff",
    baseAction: "Walk",
    cameraPosition: [-2.68, 1.74, 4.52],
    cameraLookAt: [-0.06, 1.32, 0.04],
    robotRotationY: 0.38,
  ...
  },
  {
    ...
    accent: "#b8c98a",
    baseAction: "Run",
    cameraPosition: [3.12, 1.62, 4.32],
    cameraLookAt: [0.04, 1.2, -0.06],
    robotRotationY: -0.54,
  ...
  },
  {
    ...
    accent: "#e37fa7",
    baseAction: "Idle",
    cameraPosition: [-1.74, 1.48, 4.28],
    cameraLookAt: [0.02, 1.2, 0.02],
    robotRotationY: 0.12,
